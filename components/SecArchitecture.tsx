        ...
        >
            ...
            <div className="grid grid-cols-4 gap-7 grid-rows-[220px_220px] pt-4">
                ...
                {   [1,2,3,4,5,6].map((i, index) =>
                    <div className="h-full relative self-center overflow-hidden rounded group" key={index}>
                        <Image
                            ...
                            fill
                        />
                        <div className="group-hover:bg-gradient-to-b from-black/80 via-black/5 to-black/80 absolute z-[2] inset-0">
